...
nrow(fillers) # 1940 filler trials
```
...
dd = tmp %>% 
  filter(look!="other") %>% 
  select(workerid,condition,size,list,slide_number,Name,Noun,click_onset_ms,gender_onset_ms,determiner_onset_ms,name_onset_ms,noun_onset_ms,look,target_look,competitor_look,center_look,webgazer_time,unixtlist,camview,subject_information.headphones)
...
ggsave("../graphs/prop_looks.pdf",height=3,width=8)
```
