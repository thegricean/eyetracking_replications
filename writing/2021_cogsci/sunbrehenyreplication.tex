...
\textbf{Participants.} We recruited 120 participants on Mechanical Turk. We excluded participants with accuracy lower than 95\% (n=29) and trials on which participants clicked on the wrong target (665 trials). All participants were self-reported native English speakers.\footnote{Procedure, materials, analyses and exclusions were pre-registered at https://osf.io/vfgc8/?view\_only=ad72b307653e4e02921b7173f9013da6 (Exp.~1) and https://osf.io/y2cgb/?view\_only=8acea9210ef6488b8707e1aa7d47a53e (Exp.~2). The collected sample size for Exp.~2 (183 participants) was larger than the originally pre-registered sample size (102 participants) because 40\% of the initially tested 102 participants had a technical issue and weren't able to see the whole display.}
...
\textbf{Participants.} We recruited 183 participants on Prolific, of which 21 were excluded because their accuracy was lower than 95\%. We also excluded trials on which the participants clicked the wrong target (303 trials). All participants were native English speakers.
